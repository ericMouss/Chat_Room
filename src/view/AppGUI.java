 ...
 * @author Manfo
 */
public class AppGUI extends Thread {
    
   // Ajout des composants graphique de Javax
  ...
  public AppGUI() {
    ...
    // Gestion du click sur le bouton d'envoie avec une Lambda Expression
    ...
    jtfName.getDocument().addDocumentListener((DocumentListener) new TextListener(jtfName, jtfport, jtfAddr, jcbtn));
